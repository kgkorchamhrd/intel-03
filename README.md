...
* Members
  | Name | Role |
  |----|----|
  | 안세환 | Project lead, 전체 시스템 구성, 재활방식 기획 및 개발, 기구부 제작 및 설계, AI학습 테스트 |
  | 송선대 | Project manager, 구성도 기획, 기구부 설계 및 제작, 부품 지원. |
  | 김관우 | UI design, UI제작, Unity 연결 및 개발, DB 설계, 각도 모듈 개발, PPT. |
  | 김정헌 | Embedded, 모터 작동 및 제어 개발, 힘측정 모듈 개발, 통신 프로토콜 연결 . |
  | ~~최은택~~ | ~~Architect, 프로젝트의 component를 구성하고 상위 디자인을 책임진다.~~ |

* Project Github : https://github.com/Sehwani2/AI_CPMRehab 
* 발표자료 : https://www.miricanvas.com/v/14eziyk
