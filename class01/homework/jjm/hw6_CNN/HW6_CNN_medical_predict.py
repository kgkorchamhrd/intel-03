...
model = load_model('./models/PNEUMONIA_CNN.h5')
...
fig.suptitle("Pneumonia predict CNN", fontsize=16)
...
plt.tight_layout()
plt.savefig('./src_img/CNN_PNEUMONIA_04_predict.png.png', dpi=300, bbox_inches='tight')
plt.show()
