...
x = LSTM(units = 20, activation = 'relu', return_sequences = True) (model_input)
x = Dropout(0.1) (x)
x = LSTM(units = 20, activation = 'relu') (x)
x = Dropout(0.1) (x)
...
model.save('./models/Finance_LSTM.h5')
...
plt.savefig('./src_img/Finance_LSTM_01_Loss.png', dpi=300, bbox_inches='tight')
plt.close()
