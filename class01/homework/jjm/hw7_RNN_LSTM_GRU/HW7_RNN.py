...
x = SimpleRNN(units = 20, activation = 'tanh', return_sequences = True) (model_input)
x = Dropout(0.1) (x)
x = SimpleRNN(units = 20, activation = 'tanh') (x)
x = Dropout(0.1) (x)
...
model.save('./models/Finance_RNN.h5')
...
plt.savefig('./src_img/Finance_RNN_01_Loss.png', dpi=300, bbox_inches='tight')
plt.close()
